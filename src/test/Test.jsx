...
import {Maindiv, ColumnDivQuest, DivQuest, TextQuest, NamedQuest, InputTask, Answer, IconsBackRed, IconsBackGrenn, TextMain, AboutText} from './styledcomponents'
  ...
  return (
    <div>
     ...
     <IconsBackGrenn src={LogoGreen}/>
      <Maindiv> 
        <TextMain>ТЕСТ</TextMain>
        <AboutText>о тесте</AboutText>
        {renderList}
      </Maindiv>
   </div>
  )
